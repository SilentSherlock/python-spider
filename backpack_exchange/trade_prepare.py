...
def load_backpack_api_keys_trade_cat_funding(path="C:\\Users\\15361\\OneDrive\\文档\\finance\\api\\backpack\\TradeCat-Funding.txt"):
    """
...
def load_okx_api_keys_trade_cat_okx(path="C:\\Users\\15361\\OneDrive\\文档\\finance\\api\\okx\\TradeCat-OKX-Test.txt"):
    return load_okx_api_keys(path)
